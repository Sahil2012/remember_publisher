...
export function Features() {
    ...
    return (
        <section id="offerings" className="py-32 bg-background border-t border-border/40">
            <div className="container px-6 md:px-8 mx-auto max-w-7xl">
                ...
                <div className="mb-24 max-w-2xl">
                    <motion.h2
                        ...
                        className="text-4xl md:text-5xl font-semibold tracking-tighter mb-6 text-foreground"
                    >
                    ...
                    {offerings.map((offer, index) => {
                        ...
                        return (
                            <motion.div
                                ...
                                className="group"
                            >
                                <div className="flex items-center justify-center w-14 h-14 bg-secondary rounded-2xl mb-6 text-foreground">
